...
{{ csrf_field() }} {{ method_field('PATCH') }}
					<div class="card-body">
						<div class="form-grup">
							...
							<input type="text" name="name" class="form-control col-9" required id="name" style="display: inline;" value="{{ $categories->name }}">
						</div>
						<div class="form-grup">
							<div style="margin-top: 20px;">
								<label for="price" class="form-label">Category Price</label>
								<input type="text" name="price" class="form-control col-9" required id="price" style="display: inline;" placeholder="$" value="{{ $categories->price }}">
							</div>
						</div>
					</div>
		...
		<div class="col-6">
			<div class="alert alert-info">
				Fill this form to Edit <b>{{ $categories->name }}</b>
			</div>
		</div>
	</div>
